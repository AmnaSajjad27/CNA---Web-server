...
void Send_Headers(int socket, int status_code, const char *status_phrase)
{
    ...
    // For a HEAD request, Content-Length should be included
    sprintf(response_buffer + strlen(response_buffer), "Content-Length: %d\r\n", 0); // 0 for no body
    // End of headers
